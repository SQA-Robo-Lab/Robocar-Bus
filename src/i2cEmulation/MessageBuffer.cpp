// Original file from https://github.com/SQA-Robo-Lab/Overtaking-Cars/blob/hal_demo/arduino-containers_demo_hal/generated-files/slowCarDriverECU/MessageBuffer.c
...
bool_t MessageBuffer_enqueue(MessageBuffer *buf, const void *msg)
{
    ...
    { // replace oldest message in buffer
